        ...
        return `<div id="info">
                ...
                <div id="customize">
                   ...
                   <label class="${exercise.count ? 'visible' : 'hidden'}">
                        <input type="number" max="99" style="width:35px;" value="${Number(exercise.count)}">
                    </label>
                    <label class="${exercise.sets ? 'visible' : 'hidden'}">
                        <input type="number" max="9" style="width:35px;" value="${Number(exercise.sets)}"> set(s)
                    </label>
                </div>
